...
export class RideDetailsComponent implements OnInit {
  ...
  editRide(id) {
    ...
    this.rideThang
      .edit(this.ride.theRide._id, this.rideInfo)
      .toPromise()
      .then(rideFromApi => {
        this.ride = {
          updateName: "",
  ...
  getRideDetails(id) {
    this.rideThang.get(id).subscribe(ride => {
  ...
  saveNewComment(id) {
    ...
    this.rideThang
      .newComment(this.ride.theRide._id, this.commentInfo)
      .subscribe(
        newCommentFromApi => {
  ...
  deleteRide() {
    if (window.confirm("Are you sure?")) {
      this.rideThang.remove(this.ride.theRide._id).subscribe(() => {
